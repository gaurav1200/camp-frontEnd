  ...
  return (
    <div>
      ...
      <div className="main1">
        ...
        <p>Welcome to bestcampgrounds!</p>
        <p>
          These terms and conditions outline the rules and regulations for the
          use of IACSD 's Website, located at bestcampgroundstovisit.com.
        </p>
        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use bestcampgrounds if you do not agree
        ...
        <p>
          We employ the use of cookies. By accessing bestcampgrounds, you agreed
          to use cookies in agreement with the IACSD 's Privacy Policy.{" "}
        </p>
        <p>
        ...
        <p>
          Unless otherwise stated, IACSD and/or its licensors own the
          intellectual property rights for all material on bestcampgrounds. All
          intellectual property rights are reserved. You may access this from
          bestcampgrounds for your own personal use subjected to restrictions
          set in these terms and conditions.
        </p>
        <p>You must not:</p>
        <ul>
          <li>Republish material from bestcampgrounds</li>
          <li>Sell, rent or sub-license material from bestcampgrounds</li>
          <li>Reproduce, duplicate or copy material from bestcampgrounds</li>
          <li>Redistribute content from bestcampgrounds</li>
        </ul>
        <p>
        ...
        <p>
          ...
          IACSD does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of IACSD ,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, IACSD shall not be liable for
        ...
        <p>
          IACSD reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant IACSD a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of IACSD ; and (d) the link is
        ...
        <p>
          ...
          sending an e-mail to IACSD . Please include your name, your
        ...
        <p>
          No use of IACSD 's logo or other artwork will be allowed for linking
